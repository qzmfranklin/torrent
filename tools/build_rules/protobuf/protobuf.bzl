# This file is modifed from:
#       https://github.com/google/protobuf/blob/master/BUILD
# It is only used to build third_party/cc/protobuf.
#
# If you want to use the py_proto_library() rule to build your own application,
# please use the one defined in py_proto_library.bzl.

PROTOBUF_REPO_PATH = "//third_party/cc/protobuf"

load("//tools/build_rules/grpc:grpc.bzl", "GRPC_REPO_PATH")
...
def cc_proto_library(
        ...
        cc_libs=[],
        include=None,
        protoc="%s:protoc" % PROTOBUF_REPO_PATH,
        internal_bootstrap_hack=False,
        use_grpc_plugin=False,
        default_runtime="%s:protobuf" % PROTOBUF_REPO_PATH,
        **kargs):
  ...
  if use_grpc_plugin:
    grpc_cpp_plugin = "%s:grpc_cpp_plugin" % GRPC_REPO_PATH
...
def py_proto_library(
        ...
        py_extra_srcs=[],
        include=None,
        default_runtime="%s:protobuf_python" % PROTOBUF_REPO_PATH,
        protoc="%s:protoc" % PROTOBUF_REPO_PATH,
        use_grpc_plugin=False,
        **kargs):
  ...
  if use_grpc_plugin:
    grpc_python_plugin = ":grpc_python_plugin" % GRPC_REPO_PATH
