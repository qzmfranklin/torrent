...
def get_resource(relpath):
    '''Get the absolute path for a resource file by its relative path.

    :param relpath: The relative path to look for.
    :type relpath: String or pathlib.Path.
    '''
