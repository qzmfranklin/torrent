...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__shape

#else
#  define SWIG_init    init_shape

#endif
#define SWIG_name    "_shape"
...
SWIGINTERN PyObject *_wrap_Shape_perimeter(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_Shape, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Shape_perimeter" "', argument " "1"" of type '" "Shape const *""'"); 
  }
  arg1 = reinterpret_cast< Shape * >(argp1);
...
SWIGINTERN PyObject *_wrap_Circle_perimeter(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_Circle, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Circle_perimeter" "', argument " "1"" of type '" "Circle const *""'"); 
  }
  arg1 = reinterpret_cast< Circle * >(argp1);
...
SWIGINTERN PyObject *_wrap_Square_area(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Square_area" "', argument " "1"" of type '" "Square const *""'"); 
  }
...
SWIGINTERN PyObject *_wrap_Square_perimeter(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_Square, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Square_perimeter" "', argument " "1"" of type '" "Square const *""'"); 
  }
  arg1 = reinterpret_cast< Square * >(argp1);
